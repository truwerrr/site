      ...
      <div className="container flex h-14 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {auth ? (
            ...
            <>
              <Link href="/sessions/signin" className="text-sm hover:text-primary">
                Войти
              </Link>
              <Link
          ...
          <div className="hidden md:flex items-center gap-2">
            <button className="px-2.5 py-1 rounded-md border text-xs text-[#2f2d42] bg-white">RU ▾</button>
            {auth && (
              <Link href="/profile" aria-label="Профиль" className="h-9 w-9 inline-flex items-center justify-center rounded-md border bg-white hover:bg-gray-50">
                <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 4-6 8-6s8 2 8 6"/></svg>
              </Link>
            )}
          </div>
          <button aria-label="Меню" onClick={() => setOpen((v) => !v)} className="md:hidden inline-flex h-9 w-9 items-center justify-center rounded border">
      ...
      {open && (
        <div className="md:hidden border-t bg-white">
          <div className="container py-3 flex flex-col gap-3">
            {nav.map((n) => (
              <Link key={n.href} href={n.href} className="py-1 hover:text-primary" onClick={() => setOpen(false)}>
                {n.label}
              </Link>
            ))}
          </div>
